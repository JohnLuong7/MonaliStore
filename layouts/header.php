...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a href="index.php">
    <img src="./assets/images/logo1.png" width="200px" height="60px" alt="Logo">
</a>

        <!-- Menu chính -->
        <div class="navbar-nav ms-auto">
            
            <a class="nav-link menu-link" href="index.php">TRANG CHỦ</a>
            

     <div class="nav-item dropdown menu-list-item">
    <a class="nav-link menu-link dropdown-toggle" href="all_product.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">SẢN PHẨM<i class="" aria-hidden="true"></i></a>
    ...
    <div class="megamenu-sub">
        ...
        <div class="megamenu-sub-wrap megamenu-sub-level1 row">
                ...
                <a href="TOPS.php">ÁO</a>
                <div class="megamenu-sub-level2">
                    <div class="item">
                        <a href="T-SHIRTS.php"><i class=""></i>ÁO <i class="fas fa-thunderstorm    "></i></a>
                    </div>
                    <div class="item">
                        <a href="SHIRTS.php"><i class=""></i>ÁO SƠ-MI</a>
                    </div>
                    <div class="item">
                        <a href="OUTERWEARS.php"><i class=""></i>ÁO KHOÁC</a>
                    </div>
                </div>
            </div>
                ...
                <div class="megamenu-sub-level2">
                    <div class="item">
                        <a href="SWEATSHIRTS & HOODIES.php"><i class=""></i>ÁO NỈ & ÁO HOODIE</a>
                    </div>
                    <div class="item">
                        <a href="SWEATERS & CARDIGANS.php"><i class=""></i>ÁO LEN & CARDIGANS</a>
                    </div>
                </div>
            </div>
            ...
            <!-- QUẦN -->
            <div class="item col-2">
                <a href="BOTTOMS.php">QUẦN</a>
                <div class="megamenu-sub-level2">
                    <div class="item">
                        <a href="SHORTS.php">
                            <i class=""></i>QUẦN SHORTS</a>
                    </div>
                    <div class="item">
                        <a href="PANTS.php">
                            <i class=""></i>QUẦN DÀI</a>
                    </div>
                </div>
                ...
                <!-- TÚI -->
            <div class="item col-2">
                <a href="BAGS.php">GIỎ XÁCH</a>
                <div class="megamenu-sub-level2">
                    <div class="item">
                        <a href="MINI BAGS.php">
                            <i class=""></i>TÚI XÁCH</a>
                    </div>
                    <div class="item">
                        <a href="BIG BAGS.php">
                            <i class=""></i>BALO</a>
                  ...
                  <!-- PHỤ KIỆN -->
                  <div class="item col-2">
                <a href="ACCESSORIES.php">PHỤ KIỆN</a>
            </div> 
        </div>
    </div>
</div>
            ...
            <a class="nav-link menu-link" href="abouts.php">VỀ CHÚNG TÔI</a>
