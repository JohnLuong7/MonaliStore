                        ...
                        <tr class="text-uppercase font-weight">
                            ...
                            <td>
                                <form action="order_details.php" method="POST">
                                    ...
                                    <input type="submit" name="order_details" class="btn custom-badge" value="Chi tiết">
                                </form>
                            </td>
                            <td>
                                <a href="return_contact.php?order_id=<?php echo $row['order_id']; ?>" class="btn custom-badge">Liên hệ đổi trả</a>
                            </td> <!-- Nút liên hệ đổi trả -->
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
