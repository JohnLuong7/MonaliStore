...
body {
    ...
    background-color: #f4f6f9;  /* Nền sáng, dễ nhìn */
    margin: 0;
    padding: 0;
}
...
#order-section {
    ...
    box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); /* Tạo bóng đổ để làm nổi bật */
    border-radius: 10px;
    margin-top: 50px;
    text-align: center;
}
...
<section id="order-section" class="my-5 py-5">
    ...
    <div class="container text-center">
        ...
        <div class="qr-container my-4">
            <img src="./assets/images/zalo.jpg" alt="QR Zalo" class="img-fluid" style="max-width: 250px;">
        </div>

        <p class="fs-5">Vui lòng liên hệ chúng tôi qua Zalo để đặt hàng trước.</p>
        <p class="fs-5">Monali xin chân thành cảm ơn.</p>
    </div>
</section>
