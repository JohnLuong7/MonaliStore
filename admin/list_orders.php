...
<div class="content-wrapper">
    ...
    <tr>
        ...
        <td>
            <form action="remove_order.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this order? This action cannot be undone.');">
                <input type="hidden" name="order_id" value="<?php echo $order['order_id']; ?>">
                <input type="submit" name="remove_order" style="background-color: red; color: white; border-radius: 8px; padding: 8px 16px; border: none; cursor: pointer;" value="Remove">
            </form>
